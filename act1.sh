...
mkdir star_wars/empire star_wars/rebellion   (or if i had changed into star_wars directory first, its just:  mkdir empire rebellion)
# 3. Inside the empire directory, create a file called darth_vader.txt 
cd empire, then touch darth_vader.txt
