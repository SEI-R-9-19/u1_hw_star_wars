...
mv -t millenium_falcon chewbacca.txt han_solo.txt luke_skywalker.txt princess.leia.txt
# 4. Move the millenium_falcon back into the rebellion directory.
mv millenium_falcon/ ~/ga_seir/Unit_1/Homework/u1_hw_star_wars/star_wars/rebellion
