...
mv luke_skywalker.txt obi_wan.txt princess_leia.txt han_solo.txt chewbacca.txt /Users/maxcalabro/ga_seir/unit1/homework/u1_hw_star_wars/star_wars/empire/death_star
...
mv luke_skywalker.txt princess_leia.txt han_solo.txt chewbacca.txt /Users/maxcalabro/ga_seir/unit1/homework/u1_hw_star_wars/star_wars/empire/death_star/millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
mv millenium_falcon /Users/maxcalabro/ga_seir/unit1/homework/u1_hw_star_wars/star_wars/rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader.txt /Users/maxcalabro/ga_seir/unit1/homework/u1_hw_star_wars/star_wars/empire
