...
mv star_wars/empire/death_star/chewbacca.txt star_wars/empire/death_star/millenium_falcon
mv star_wars/empire/death_star/han_solo.txt star_wars/empire/death_star/millenium_falcon
mv star_wars/empire/death_star/luke_skywalker.txt star_wars/empire/death_star/millenium_falcon
mv star_wars/empire/death_star/princess_leia.txt star_wars/empire/death_star/millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
mv -f star_wars/empire/death_star/millenium_falcon star_wars/rebellion
