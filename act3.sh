...
Chriss-MacBook-Pro:millenium_falcon creativecomp$ trash obi_wan.txt
...
mv death_star/*.txt death_star/millenium_falcon 
mv death_star/millenium_falcon/darth_vader.txt death_star
# 4. Move the millenium_falcon back into the rebellion directory.
Chriss-MacBook-Pro:star_wars creativecomp$ mv empire/millenium_falcon rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
Chriss-MacBook-Pro:star_wars creativecomp$ mv empire/death_star/darth_vader.txt empire
# 6. Thanks to his practice back home at Beggar’s Canyon, Luke blew up the death_star! Remove it from the galaxy!
Chriss-MacBook-Pro:star_wars creativecomp$ trash empire/death_star