...
mv star_wars/empire/death_star/*.txt star_wars/empire/death_star/millenium_falcon && mv star_wars/empire/death_star/millenium_falcon/darth_vader.txt star_wars/empire/death_star
