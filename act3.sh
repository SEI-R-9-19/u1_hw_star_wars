...
empire git:(main) ✗ mv death_star/millenium_falcon/*.txt death_star/
...
empire git:(main) ✗ mv death_star/chewbacca.txt death_star/millenium_falcon
➜  empire git:(main) ✗ mv death_star/han_solo.txt death_star/luke_skywalker.txt death_star/princess_leia.txt death_star/millenium_falcon 
# 4. Move the millenium_falcon back into the rebellion directory.
star_wars git:(main) ✗ mv empire/millenium_falcon/ rebellion
