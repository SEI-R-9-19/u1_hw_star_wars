...
mv  u1_hw_star_wars/star_wars/empire/millenium_falcon u1_hw_star_wars/star_wars/empire/death_star  
...
mv u1_hw_star_wars/star_wars/empire/death_star/* u1_hw_star_wars/star_wars/rebellion/millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
mv u1_hw_star_wars/star_wars/empire/millenium_falcon u1_hw_star_wars/star_wars/rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv u1_hw_star_wars/star_wars/empire/death_star/darth_vader u1_hw_star_wars/star_wars/empire
