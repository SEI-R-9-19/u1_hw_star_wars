...
millenium_falcon/* ~/ga_seir/unit1/homework/u1_hw_star_wars/star_wars/empire/death_star
...
mv luke_skywalker.txt han_solo.txt princess_leia.txt chewbacca.txt ~/ga_seir/unit1/homework/u1_hw_star_wars/star_wars/empire/death_star/millenium_falcon
...
mv darth_vader.txt ~/ga_seir/unit1/homework/u1_hw_star_wars/star_wars/empire
