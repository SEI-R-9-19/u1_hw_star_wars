...
mv death_star/luke_skywalker.txt death_star/millenium_falcon
mv death star/luke_skywalker.txt death_star/millenium_falcon 
mv death_star/han_solo.txt death_star/millenium_falcon
