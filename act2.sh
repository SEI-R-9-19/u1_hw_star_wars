...
touch star_wars/rebellion/princess_leia.txt && echo "Help me, Obi_Wan..." >> star_wars/rebellion/princess_leia.txt
...
mv star_wars/rebellion/luke_skywalker.txt star_wars/rebellion/millenium_falcon
...
git add .
git commit  -m "created directories for act 1 and filled rebellion cast/starship and moved them to attack the empire"