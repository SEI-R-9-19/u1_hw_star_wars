...
touch millenium_falcon/han_solo.txt && touch millenium_falcon/chewbacca.txt
# 6. Move luke_skywalker, obi_wan, and princess_leia into the millenium_falcon, respectively.
mv luke_skywalker.txt obi_wan.txt princess_leia.txt millenium_falcon
# 7. Move the millenium_falcon into the death_star.
mv millenium_falcon /Users/Justin/ga_seir/unit1/homework/u1_hw_star_wars/star_wars/empire/death_star