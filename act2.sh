...
touch princess_leia.txt && echo echo "Help me, Obi-Wan...">> princess_leia.txt
...
# 6. Move luke_skywalker, obi_wan, and princess_leia into the millenium_falcon, respectively.
 mv luke_skywalker.txt  millenium_falcon && mv obi_wan.txt millenium_falcon && mv princess_leia millenium_falcon
