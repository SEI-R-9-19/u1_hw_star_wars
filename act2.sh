...
star_wars git:(main) ✗ mv rebellion/luke_skywalker.txt rebellion/millenium_falcon
star_wars git:(main) ✗ mv rebellion/obi_wan.txt rebellion/millenium_falcon    
star_wars git:(main) ✗ mv rebellion/princess_leia.txt rebellion/millenium_falcon
