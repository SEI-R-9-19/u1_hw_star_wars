...
cd millenium_falcon, then touch han_solo.txt chewbacca.txt
# 6. Move luke_skywalker, obi_wan, and princess_leia into the millenium_falcon, respectively.
.., then mv luke_skywalker.txt obi_wan.txt princess_leia.txt millenium_falcon/
# 7. Move the millenium_falcon into the death_star.
from star_wars directory (had to use sudo command due to permissions issues):
sudo mv rebellion/millenium_falcon empire/death_star